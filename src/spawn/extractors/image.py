...
class ImageMetadataExtractor(MetadataExtractor):
    ...
    def extract(self, file_path: Path) -> Dict[str, Any]:
        ...
        try:
            ...
            try:
                ...
                has_pil = False
                metadata["error"] = "PIL/Pillow library not available for image processing"
                return metadata
            ...
            with Image.open(file_path) as img:
                ...
                metadata["aspect_ratio"] = round(img.width / img.height, 3) if img.height > 0 else None
                ...
                if self.extract_exif and hasattr(img, "_getexif") and callable(img._getexif):
                ...
                for key, value in img.info.items():
                    if key not in ("exif",) and isinstance(value, (str, int, float, bool)):
    ...
    def _extract_color_info(self, img, max_colors: int = 5, sample_size: int = 100) -> Dict[str, Any]:
        """
